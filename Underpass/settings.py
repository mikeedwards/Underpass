...
# Django settings for Underpass project.

# Helper lambda for gracefully degrading environmental variables:
env = lambda e, d: environ[e] if os.environ.has_key(e) else d
...
ROOT_URLCONF = 'Underpass.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Underpass.wsgi.application'
