...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Level.user'
        db.delete_column('core_level', 'user_id')


    def backwards(self, orm):
        # Adding field 'Level.user'
        db.add_column('core_level', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='levels', to=orm['auth.User']),
                      keep_default=False)
