...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Level.description'
        db.add_column('core_level', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Kit.description'
        db.add_column('core_kit', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Level.description'
        db.delete_column('core_level', 'description')

        # Deleting field 'Kit.description'
        db.delete_column('core_kit', 'description')
